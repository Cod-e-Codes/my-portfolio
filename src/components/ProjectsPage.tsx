...
const projects: Projects = {
    "Web Development": [
        ...
        {
            title: 'Dat A Boi Tire Sales',
            description: 'An e-commerce website for a tire sales business with a clean, modern look.',
            status: 'Completed',
            github: '#',
            demo: '#',
        ...
        },
        {
            ...
            description: 'A landing page design for Dat A Boi Enterprises.',
            status: 'Completed',
            github: '#',
            demo: '#',
            technologies: ['HTML', 'CSS', 'Bootstrap'],
    ...
    "Mobile Development": [
        ...
        {
            title: 'Dat A Boi Studios App',
            description: 'A photography and portfolio app for a freelance photography business.',
            status: 'Ongoing',
            github: '#',
    ...
    "Tools and AI": [
        ...
        {
            title: 'Flutter Remote Compiler',
            description: 'A tool for compiling Flutter apps remotely for faster development.',
            status: 'Ongoing',
            github: '#',
            technologies: ['Flutter', 'Dart', 'CI/CD'],
        },
    ],
    "Games and Experiments": [
        ...
        {
            title: 'Mille Bornes Game',
            description: 'A digital version of the Mille Bornes card game.',
            status: 'Ongoing',
            github: '#',
            technologies: ['Flutter', 'Game Design'],
        },
        {
            ...
            status: 'Completed',
            github: '#',
            technologies: ['Flutter', 'Socket Programming'],
        },
        {
        ...
        },
        {
            ...
            description: 'A simulation game exploring ethical hacking and cybersecurity techniques.',
            status: 'Prototype',
            github: '#',
            technologies: ['Flutter', 'Game Design'],
        },
        ...
        {
            title: 'The Empathy Experience',
            description: 'An immersive, multi-sensory web application designed to foster empathy and connection using interactive 3D experiences.',
            status: 'Ongoing',
            github: '#',
            technologies: ['React', 'React-Three-Fiber', 'Webpack', 'Babel'],
        },
    ],
    "Scripts and Tools": [
        {
